...
const [manufacturingDashboard, employees, departments, factoryStructure, stages, models, lineStaffing, dailyProductionOperations, reports] = MANUFACTURING_WORKSPACE_ITEMS;
...
export const MANUFACTURING_WORKSPACE_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'compensation', redirectTo: 'models', pathMatch: 'full' },
      ...
      { path: 'orders', redirectTo: 'daily-production-operations', pathMatch: 'full' },
      { path: 'production-recording', redirectTo: 'daily-production-operations', pathMatch: 'full' },
